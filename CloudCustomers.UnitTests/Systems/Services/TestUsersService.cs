...
namespace CloudCustomers.UnitTests.Systems.Services
{
    public class TestUsersService
    {
        ...
        [Fact]
        public async Task GetAllUsers_WheHits404_ReturnsEmptyListOfUsers()
        {
            // Arrange
        ...
        public async Task GetAllUsers_WhenCalled_InvokesConfiguredExternalUrl()
        {
            ...
            // Assert
            handlerMock.Protected().Verify("SendAsync", Times.Exactly(1), ItExpr.Is<HttpRequestMessage>(req => req.Method == HttpMethod.Get && req.RequestUri == uri), ItExpr.IsAny<CancellationToken>());
        }
    }
}
